...
fn verify_solutions() {
    ...
    assert_eq!(pe041::solve().to_string(), "7652413");
    assert_eq!(pe042::solve().to_string(), "162");
    assert_eq!(pe043::solve().to_string(), "16695334890");
    assert_eq!(pe044::solve().to_string(), "5482660");
